...
- Name: app.spec.ts >> Incorrect title tab loads
...
Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    11 × unexpected value "Repair Shop"
...
```ts
  ...
  4  | 
  5  | test('correct ttile tab loads', async ({ page }) => {
  ...
  10 | 
  11 | 
  12 | test('Incorrect title tab loads', async ({ page }) => {
